    ...
    tabPanel(title = 'Data',
             fluidRow(
               ...
               box(width = 3,status="success",
                   ...
                   column(width = 12,selectInput(ns('na_omit'), lang$t("Continuous variables"), c(T,F),selected = T )),
                   hr(),
    ...
    tabPanel(title = 'Result',
             fluidRow(
               box(title=lang$t("Result"),width=9,solidHeader=TRUE,status='primary',background = "white",
                   splitLayout(cellWidths = c("100%"), rhandsontable::rHandsontableOutput(ns("resultTable") ) ) ),
               box(width = 3,status="success",
