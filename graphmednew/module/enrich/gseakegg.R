...
gseakeggUI <- function(id) {
  ...
  tagList(
    bs4Dash::tabsetPanel(
               ...
               fluidRow(
                 ...
                 box(width = 3,status="success",
                     ...
                     fluidRow(
                       ...
                       column(width = 12, selectInput( inputId = ns("logFC_col"), label = h6(lang$t('logFC 列'),style = "color:orange"),  c("")))
                     ),
      ...
      tabPanel(title = 'GSEA',
               fluidRow(
                 ...
                 box(width = 3,status="success",
                     ...
                     selectInput( inputId = ns("plot_gsea_id1"), lang$t("图形选择："),c( "p_dot","p_bar","p_emap") ),
      ...
      tabPanel(title = 'Help', gseakegg_helpUI("gseakegg"))
      )
  ) # NS(id)
} # function(id) 
