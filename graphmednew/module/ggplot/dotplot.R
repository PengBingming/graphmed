                     ...
                     column(width =3,
                            dropdownButton(circle=FALSE, label= lang$t("基础"),size = "sm", br(),br(),
                                           fluidRow(
                                             ...
                                             column(width = 6, textInput(ns('title'), label = "plot.title", value = "Dotplot" )),
                ...
                plot <- reactive({
                  ...
                  if( T ){ 
                    if(!input$x==''){
                      ...
                      dotplot <- paste0("geom_dotplot(mapping = aes(x=",input$x,
                                        ",color=",input$color,
                                        ",fill=",input$fill,")",
                      ...
                      dotplot <- paste0("geom_dotplot(mapping = aes(y=",input$y,
                                        ",color=",input$color,
                                        ",fill=",input$fill,")",
                                        ",show.legend=",input$show.legend_dotplot,
                                        ",method=","'",input$method_dotplot,"'",
