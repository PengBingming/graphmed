                           ...
                           column(width =3,
                                  dropdownButton(circle=FALSE, label= lang$t("基础"),size = "sm", br(),br(),
                                                 fluidRow(
                                                   ...
                                                   column(width = 6, textInput(ns('title'), label = "plot.title", value = "Histogram" )),
                ...
                plot <- reactive({
                  ...
                  if( T ){
                    if(!input$x==''){
                      ...
                      histogram <- paste0("geom_histogram(mapping = aes(x=",input$x,
                                          ",color=",input$color,
                                          ",fill=",input$fill,")",
                      ...
                      histogram <- paste0("geom_histogram(mapping = aes(y=",input$y,
                                          ",color=",input$color,
                                          ",fill=",input$fill,")",
                                          ",show.legend=",input$show.legend_histogram,
                                          ",alpha=",input$alpha_histogram,
