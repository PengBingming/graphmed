...
gseagoUI <- function(id) {
  ...
  tagList(
    bs4Dash::tabsetPanel(
      tabPanel(title = 'Data',
               fluidRow(
                 ...
                 box(width = 3,status="success",
                     ...
                     fluidRow(
                       column(width = 6,
                              selectInput(inputId = ns("ID"),label = h6(lang$t('GeneID'), style = "color:orange"),
                                          c("")) ),
                       column(width = 6, 
                              selectInput(inputId = ns("species"), h6(lang$t("Species"), style = "color:orange"),selected = "hsa",
                                          choices = c('human'= "hsa", 'mouse' = "mmu", "rat" ="rat") ) ) ,
                       column(width = 12, 
                              selectInput( inputId = ns("logFC_col"),
                                           label = h6(lang$t('logFC column'),style = "color:orange"),
                                           c("") ) )
                     ),
      ...
      tabPanel(title = 'GSEA',
               fluidRow(
                 ...
                 box(width = 3,status="success",
                     ...
                     selectInput( inputId = ns("plot_gsea_id1"), lang$t("Graphic selection"),c( "p_dot","p_emap") ),
      ...
      tabPanel(title = 'Help',helpUI("gseago"))
      )
  ) # NS(id)
} # function(id) 
