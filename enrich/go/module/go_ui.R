...
goUI <- function(id) {
  ...
  tagList(
    bs4Dash::tabsetPanel(
      tabPanel(title = 'Data',
               fluidRow(
                 ...
                 box(width = 3,status="success",
                     ...
                     selectInput(ns('type'),lang$t('Input data type'),selected = 'gene',choices = c('diff gene'='gene','diff matrix'='DEG')),
                     conditionalPanel(
      ...
      tabPanel(title = 'GO',
               fluidRow(
                 box(title=lang$t("GO analysis"),width=9,solidHeader=TRUE,status = "primary",background = "white",
                 ...
                 box(width = 3,status="success",
                     ...
                     selectInput(ns("plot_kegg_id1"), lang$t("Graphic selection"), choices = c("p_dot","p_bar", "p_emap") ),
                     numericInput(inputId = ns("kegg_num0"),  label = lang$t('Number of pathways'), value = 5),
